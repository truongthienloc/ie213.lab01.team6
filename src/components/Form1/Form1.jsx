...
function Form1() {
	...
	const handleCalculateResult = (event) => {
		...
		if (average < 5) assession = 'Yếu';
		else if (average < 6.5) assession = 'Trung bình';
		else if (average < 8) assession = 'Khá';
		else assession = 'Giỏi';
			...
			<form className="form1" method="POST" action="/">
				...
				<div className="form1__content">
					<div className="form1__group">
						<label className="form1__label" htmlFor="semester1">
							Điểm HK1:
						</label>
						<input
					...
					<div className="form1__group">
						<label className="form1__label" htmlFor="semester2">
							Điểm HK2:
						</label>
						<input
							className="form1__input"
					...
					<div className="form1__group">
						<label className="form1__label" htmlFor="average">
							Điểm trung bình:
						</label>
						<input
					...
					<div className="form1__group">
						<label className="form1__label" htmlFor="result">
							Kết quả:
						</label>
						<input
							className="form1__input readOnly"
					...
					<div className="form1__group">
						<label className="form1__label" htmlFor="assession">
							Xếp loại học lực:
						</label>
						<input
							className="form1__input readOnly"
					...
					<div className="form1__group">
						<button className="form1__btn" onClick={handleCalculateResult}>
							Xem kết quả
						</button>
					</div>
				</div>
